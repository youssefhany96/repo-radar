...
function createThemeWithVars(options = {}, ...args) {
  ...
  Object.keys(theme.colorSchemes).forEach(key => {
    ...
    if (palette.mode === 'light') {
      ...
      setColor(palette.TableCell, 'border', colorMix(_colorManipulator.private_safeLighten, (0, _colorManipulator.private_safeAlpha)(nativeColor ? getCssVar('palette-divider') : palette.divider, 1), 0.88));
  ...
  const focusVisibleInput = (0, _focusVisible.mergeFocusVisibleInput)(options.focusVisible, args);
  if (focusVisibleInput != null && focusVisibleInput !== false) {
    theme.focusVisible = (0, _focusVisible.resolveFocusVisible)(focusVisibleInput, getCssVar('palette-primary-main'));
  }
  const parserConfig = {
    prefix: cssVarPrefix,
