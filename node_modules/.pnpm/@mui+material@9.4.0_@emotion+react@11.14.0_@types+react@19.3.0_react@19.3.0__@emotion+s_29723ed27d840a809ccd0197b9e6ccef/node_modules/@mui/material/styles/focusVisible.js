...
exports.applyChildrenFocusVisible = applyChildrenFocusVisible;
exports.applyInsetFocusVisible = applyInsetFocusVisible;
exports.isResolvedFocusVisible = isResolvedFocusVisible;
exports.mergeFocusVisibleInput = mergeFocusVisibleInput;
exports.outsetFocusRing = void 0;
exports.resolveFocusVisible = resolveFocusVisible;
exports.wireFocusVisibleVars = wireFocusVisibleVars;
...
const outsetFocusRing = exports.outsetFocusRing = {
...
function mergeFocusVisibleInput(optionsFocusVisible, args) {
  return args.reduce((acc, arg) => arg && 'focusVisible' in arg ? (0, _deepmerge.default)(acc, {
...
function wireFocusVisibleVars(resolved) {
  ...
  const standaloneBoxShadows = new Set(['none', 'initial', 'inherit', 'unset', 'revert', 'revert-layer']);
