...
...args) {
  ...
  if (cssVariables === false) {
    ...
    if (theme.focusVisible != null && theme.focusVisible !== false) {
      ...
      const rawFocusVisible = (0, _focusVisible.mergeFocusVisibleInput)(options.focusVisible, args);
      ...
      if (!authoredColor || (0, _focusVisible.isResolvedFocusVisible)(rawFocusVisible) && authoredColor === theme.palette.primary.main) {
        const {
          outlineColor,
          ...rest
        } = focusVisibleInput;
      ...
      Object.keys(theme.colorSchemes).forEach(scheme => {
        ...
        if (schemePalette?.primary) {
          theme.colorSchemes[scheme].focusVisible = (0, _focusVisible.resolveFocusVisible)(focusVisibleInput, schemePalette.primary.main);
        }
      });
    }
    return theme;
