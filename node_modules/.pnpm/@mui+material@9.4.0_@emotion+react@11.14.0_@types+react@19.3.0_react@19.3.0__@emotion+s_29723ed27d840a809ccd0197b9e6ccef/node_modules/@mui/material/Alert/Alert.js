...
const useUtilityClasses = ownerState => {
  ...
  const slots = {
    root: ['root', `color${(0, _capitalize.default)(color || severity)}`, `${variant}`],
    icon: ['icon'],
    message: ['message'],
    action: ['action']
  };
...
const AlertRoot = (0, _zeroStyled.styled)(_Paper.default, {
  ...
  return {
    ...
    variants: [...Object.entries(theme.palette).filter((0, _createSimplePaletteValueFilter.default)(['light'])).map(([color]) => ({
      ...
      style: {
        ...(theme.focusVisible && (0, _focusVisible.applyChildrenFocusVisible)(`0 0 0 4px ${(theme.vars || theme).palette.background.default}`)),
